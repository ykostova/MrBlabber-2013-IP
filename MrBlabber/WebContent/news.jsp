			...
			<div class="container">
				...
				<div class="nav-collapse collapse">
					<ul class="nav">
						...
						<li class="active"><a href="./Tweets">NEWS</a></li>
	...
	<div class="container">
		...
		<div class="span8">
			<div class="well span6 offset1">
				<ul class="unstyled">
					<li class="clearfix"><p class="text-center"><strong>Friends Tweets</strong></p><hr class="line-divider"/></li>
					<%
							LinkedList<PostStore> posts = post.getPostsForNews(
					...
					<%
						...
						%>
					<li><label class="controls"> Your friends haven't tweeted yet.</label></li>
					<li class="clearfix"><hr class="line-divider"></li>
					<%
							}
						%>
